...
public class Signup {
	...
	public Object[][] datasets(){
		Object[][] data = {{"rajesh","raje","rajesh@gmail.com","raj@123","1234567898","05/22/2000","qwertyuiopasdfghjkl"},
				           {"ra","ra","rajeshgmail","ra","dfghggffd","05/22/2000",""},
				           {"rasdfghjkihugytrsdfgh","raqwertyuiiiiiiiiiiopppppppppo","rajesh@","Raaghab243626@#$%&HRRt","@@@@@@","05/22/2000","1234567"},
				           {"@#!$","!@#$","@hddb","!@#$%","@#$&*","09/27/2001","good"},
				           {"1234","1234","QWER@GHFG","12345","qwert","09/22/2022","123456789"},
				           {"","","","","","",""}};
		return data;
	}
}
